...
public class FileController {
    ...
    @GetMapping("/downloadfile/{fileName}")
    public ResponseEntity<org.springframework.core.io.Resource> downloadFile(@PathVariable String fileName, HttpServletRequest request, HttpServletResponse response) throws UnsupportedEncodingException {
        // Load file as Resource
        Map map =fileServiceImpl.loadFileAsResource(fileName);
        org.springframework.core.io.Resource resource = (org.springframework.core.io.Resource) map.get("resource");
